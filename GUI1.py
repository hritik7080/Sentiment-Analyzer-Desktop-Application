            ...
            class Toplevel1:
                def __init__(self, top=None):
                    ...
                    def get():
                        ...
                        load = load_model('E:\\Int213\\Class work\\model1.h5')
                        print(x)
                    ...
                    def process(yelp):
                        ...
                        plt.axis('equal')
                        plt.tight_layout()
                        plt.savefig('E:\\Int213\\Class work\\grpah.png')
                        plt.show()
                        ...
                        r.add_picture('E:\\Int213\\Class work\\grpah.png')
                        r.add_text(
                            'For any assistance, feel free to contact us......\nName: Hritik Gupta, \n Contact: 7080700630, \nEmail:hritikgupta7080@gmail.com')
                        document.save('./demo.docx')
                        from PIL import Image
                        im1 = Image.open("E:\\Int213\\Class work\\grpah.png")
                        width = 260
                        height = 200
                        im1 = im1.resize((width, height), Image.NEAREST)
                        im1.save("E:\\Int213\\Class work\\grpah.png")
